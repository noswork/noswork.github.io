    ...
    async loadTranslations() {
        ...
        this.translations = {
            'zh-TW': {
                ...
                'hero_pill': 'nossite.com 中樞站點',
                'hero_subtitle_new': '將嘟嘟臉惡作劇、東京喰種與各種實用工具收納在同一個柔和立體的宇宙裡。',
                'hero_card_title': '你的工具與作品中樞',
                'hero_card_desc': 'nossite.com 以 Neumorphism 風格重新打造，成為所有子站與工具的導航中樞，在這裡你可以一眼看清每個作品、每個工具扮演的角色。',
                'hero_stat_projects': '作品展示',
                'hero_stat_tools': '實用工具',
                'hero_stat_langs': '多語系',
                'hero_cta_primary': '瀏覽作品展示頁',
                'hero_cta_secondary': '查看所有工具',
                'hero_side_title': '設計理念',
                'hero_side_desc': '主站採用柔和陰影與圓角 Neumorphism 風格，營造像桌面小工具般的觸感；進入各個展示頁時，則會無縫切換到對應作品自己的專屬視覺。',
                'hero_side_item1': '保留簡潔的 GitHub Pages 結構，方便維護與擴充',
                'hero_side_item2': '對應子網域（如 tga.nossite.com、trickcal.nossite.com）各自保有獨特風格',
                'hero_side_item3': '支援亮暗主題與多語系文字切換',
                ...
                'showcase_label': '作品展示頁',
                'showcase_title': '在各自的世界看見 NOS',
                'showcase_subtitle': '進入不同展示頁時，將沿用該作品原本的設計語言與氛圍，讓 nossite.com 成為多個風格宇宙之間的入口。',
                'showcase_trickcal_tag': '嘟嘟臉惡作劇 · trickcal.nossite.com',
                'showcase_trickcal_title': '溫暖可愛的計算與查詢實驗室',
                'showcase_trickcal_desc': '展示頁會採用與 trickcal.nossite.com 相同的色彩與卡片風格，聚焦於角色記錄、掃蕩計算與食物喜好查詢等遊戲輔助體驗。',
                'showcase_trickcal_cta': '前往嘟嘟臉展示頁',
                'showcase_tga_tag': '東京喰種 · tga.nossite.com',
                'showcase_tga_title': 'TOKYO GHOUL',
                'showcase_tga_cta': '前往東京喰種展示頁',
                'learn_more': '了解更多 →',
                'explore_map': '探索地圖 →',
                'start_game': '開始遊戲 →',
                'optimize_now': '立即優化 →',
            ...
            'zh-CN': {
                ...
                'hero_pill': 'nossite.com 中枢站点',
                'hero_subtitle_new': '将嘟嘟脸恶作剧、东京喰种与各种实用工具收纳在同一个柔和立体的宇宙里。',
                'hero_card_title': '你的工具与作品中枢',
                'hero_card_desc': 'nossite.com 以 Neumorphism 风格重新打造，成为所有子站与工具的导航中枢，在这里你可以一眼看清每个作品、每个工具扮演的角色。',
                'hero_stat_projects': '作品展示',
                'hero_stat_tools': '实用工具',
                'hero_stat_langs': '多语言',
                'hero_cta_primary': '浏览作品展示页',
                'hero_cta_secondary': '查看所有工具',
                'hero_side_title': '设计理念',
                'hero_side_desc': '主站采用柔和阴影与圆角 Neumorphism 风格，营造如桌面小工具般的触感；进入各个展示页时，则会无缝切换到对应作品自己的专属视觉。',
                'hero_side_item1': '保留简洁的 GitHub Pages 结构，方便维护与扩展',
                'hero_side_item2': '对应子域名（如 tga.nossite.com、trickcal.nossite.com）各自保有独特风格',
                'hero_side_item3': '支持亮暗主题与多语言文字切换',
                ...
                'showcase_label': '作品展示页',
                'showcase_title': '在各自的世界看见 NOS',
                'showcase_subtitle': '进入不同展示页时，将沿用该作品原本的设计语言与氛围，让 nossite.com 成为多个风格宇宙之间的入口。',
                'showcase_trickcal_tag': '嘟嘟脸恶作剧 · trickcal.nossite.com',
                'showcase_trickcal_title': '温暖可爱的计算与查询实验室',
                'showcase_trickcal_desc': '展示页会采用与 trickcal.nossite.com 相同的色彩与卡片风格，聚焦于角色记录、扫荡计算与食物喜好查询等游戏辅助体验。',
                'showcase_trickcal_cta': '前往嘟嘟脸展示页',
                'showcase_tga_tag': '东京喰种 · tga.nossite.com',
                'showcase_tga_title': 'TOKYO GHOUL',
                'showcase_tga_cta': '前往东京喰种展示页',
                'learn_more': '了解更多 →',
                'explore_map': '探索地图 →',
                'start_game': '开始游戏 →',
                'optimize_now': '立即优化 →',
            ...
            'en': {
                ...
                'hero_pill': 'nossite.com Hub',
                'hero_subtitle_new': 'Gathering TrickCal, Tokyo Ghoul, and various practical tools into a single soft, tactile universe.',
                'hero_card_title': 'Your Hub for Projects and Tools',
                'hero_card_desc': 'nossite.com is redesigned with a Neumorphism style as the navigation hub for all sub-sites and tools, giving you a clear overview of how each project and tool fits together.',
                'hero_stat_projects': 'Showcase Projects',
                'hero_stat_tools': 'Practical Tools',
                'hero_stat_langs': 'Languages',
                'hero_cta_primary': 'Browse showcases',
                'hero_cta_secondary': 'View all tools',
                'hero_side_title': 'Design Concept',
                'hero_side_desc': 'The main site uses soft shadows and rounded Neumorphism cards to feel like desktop widgets; entering each showcase switches seamlessly to that project’s own visual language.',
                'hero_side_item1': 'Keeps a simple GitHub Pages structure for easy maintenance and extension',
                'hero_side_item2': 'Each subdomain (such as tga.nossite.com, trickcal.nossite.com) preserves its unique style',
                'hero_side_item3': 'Supports light/dark themes and multi-language text switching',
                ...
                'showcase_label': 'Showcases',
                'showcase_title': 'Seeing NOS in Each World',
                'showcase_subtitle': 'Each showcase page keeps the original design language and atmosphere of its project, making nossite.com a gateway between different visual universes.',
                'showcase_trickcal_tag': 'TrickCal · trickcal.nossite.com',
                'showcase_trickcal_title': 'A Warm, Playful Lab for Calculations and Lookups',
                'showcase_trickcal_desc': 'The showcase reflects the same palette and card style as trickcal.nossite.com, focusing on character tracking, sweep calculation, and food preference tools.',
                'showcase_trickcal_cta': 'Open TrickCal showcase',
                'showcase_tga_tag': 'Tokyo Ghoul · tga.nossite.com',
                'showcase_tga_title': 'TOKYO GHOUL',
                'showcase_tga_cta': 'Open Tokyo Ghoul showcase',
                ...
                'tga_feat1': 'Character Database',
                'tga_feat2': 'Stronghold Map',
                'tga_feat3': 'RC Calculator',
                'tga_feat4': 'AI Classifier',
                'tga_feat5': 'AI Terminal',
                'tga_feat6': 'Insight Tools'
            },
            'ja': {
                'site_name': 'NOS SITE',
                'nav_home': 'ホーム',
                ...
                'hero_pill': 'nossite.com ハブサイト',
                'hero_subtitle_new': 'トリックカル、東京喰種、そして各種実用ツールを、柔らかい立体感のある一つの宇宙にまとめました。',
                'hero_card_title': '作品とツールのハブ',
                'hero_card_desc': 'nossite.com は Neumorphism スタイルで再設計され、すべてのサブサイトとツールへのナビゲーションハブとして機能し、それぞれの役割を一目で把握できます。',
                'hero_stat_projects': 'ショーケース作品',
                'hero_stat_tools': '実用ツール',
                'hero_stat_langs': '対応言語',
                'hero_cta_primary': 'ショーケースを見る',
                'hero_cta_secondary': 'ツール一覧を見る',
                'hero_side_title': 'デザインコンセプト',
                'hero_side_desc': 'メインサイトは柔らかい影と丸みのある Neumorphism カードで、デスクトップウィジェットのような触感を目指しています。各ショーケースに入ると、それぞれの作品独自のビジュアルに自然に切り替わります。',
                'hero_side_item1': 'シンプルな GitHub Pages 構成を維持し、保守と拡張を容易に',
                'hero_side_item2': 'tga.nossite.com や trickcal.nossite.com など、各サブドメインは固有のスタイルを保持',
                'hero_side_item3': 'ライト／ダークテーマと多言語切り替えに対応',
                ...
                'showcase_label': 'ショーケース',
                'showcase_title': 'それぞれの世界に映る NOS',
                'showcase_subtitle': '各ショーケースページでは、その作品本来のデザイン言語と雰囲気を引き継ぎ、nossite.com を複数のビジュアル宇宙をつなぐ入口にします。',
                'showcase_trickcal_tag': 'トリックカル · trickcal.nossite.com',
                'showcase_trickcal_title': 'やわらかく可愛い計算と検索のラボ',
                'showcase_trickcal_desc': 'ショーケースは trickcal.nossite.com と同じパレットとカードスタイルを踏襲し、キャラクター記録・掃討計算・食べ物の好み検索などのゲーム支援体験に焦点を当てます。',
                'showcase_trickcal_cta': 'トリックカルショーケースへ',
                'showcase_tga_tag': '東京喰種 · tga.nossite.com',
                'showcase_tga_title': 'TOKYO GHOUL',
                'showcase_tga_cta': '東京喰種ショーケースへ',
                'learn_more': '詳細を見る →',
                'explore_map': 'マップを探索 →',
                'start_game': 'ゲーム開始 →',
                'optimize_now': '今すぐ最適化 →',
